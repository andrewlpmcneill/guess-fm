...
storiesOf("GuessesItem", module)
  ...
  .add("incorrect guess", () => (
    <GuessesItem
      data={{ id: 1, country: "Singapore", distanceAway: 4500, direction: "N" }}
    />
  ))
  .add("correct guess", () => (
    <GuessesItem
      data={{ id: 5, country: "Norway", distanceAway: 0, direction: "" }}
    />
  ));
...
storiesOf("Results menu", module)
  .addParameters({})
  .add("Base show", () => (
    <Results guesses={DUMMY_GUESSES_DATA} score={DUMMY_SCORE_DATA}></Results>
  ))
  .add("Base hide", () => (
    <Results
      guesses={DUMMY_GUESSES_DATA}
      score={DUMMY_SCORE_DATA}
      menuStatus={false}
    ></Results>
  ))
  .add("first round no guesses", () => (
    <Results guesses={null} score={null}></Results>
  ))
  .add("first round no score", () => (
    <Results guesses={DUMMY_GUESSES_DATA} score={null}></Results>
  ))
  .add("new round no guesses", () => (
    <Results guesses={null} score={null}></Results>
  ));
