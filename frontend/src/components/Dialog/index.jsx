...
export default function Dialog(props) {
  ...
  const { round, play, pause, startGame, nextRound, clearGuesses, setAudio, setRound, game, setScore, score } = props;
  ...
  return (
    <div>
      ...
      {round > 3 && <GameOver startGame={startGame} pause={pause} setAudio={setAudio} setRound={setRound} setScore={setScore} score={score}/>} 
    </div>
  );
}