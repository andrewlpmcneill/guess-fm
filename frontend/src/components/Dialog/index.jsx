...
export default function Dialog(props) {
  ...
  const { round, play, pause, startGame, nextRound, clearGuesses, setAudio, setScore } = props;

  return (
    <div>
      {round === 0 && <Instructions startGame={startGame} round={round} nextRound={nextRound} setAudio={setAudio}/>}
      ...
      {round > 3 && <GameOver startGame={startGame} pause={pause} setScore={setScore}/>} 
    </div>
  );
}